...
const Hero = ({ bg, Title, desc }) => {
  return (
    <section
      className="relative flex items-center justify-center md:justify-start flex-col h-[60vh] md:h-[70vh] gap-3 text-[var(--background-color)] bg-cover bg-center bg-no-repeat px-4 md:px-8"
      style={{
